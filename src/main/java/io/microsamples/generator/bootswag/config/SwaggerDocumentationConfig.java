package io.microsamples.generator.bootswag.config;
...
public class SwaggerDocumentationConfig {
    ...
    ApiInfo apiInfo() {
        return new ApiInfoBuilder()
            ...
            .termsOfServiceUrl("")
            .version("1.0.0")
            .contact(new Contact("","", "apiteam@pivotal.io"))
            .build();
    }
    ...
    public Docket customImplementation(ServletContext servletContext){
        return new Docket(DocumentationType.SWAGGER_2)
                .select()
                    .apis(RequestHandlerSelectors.basePackage("io.microsamples.generator.bootswag.api"))
                .build()
